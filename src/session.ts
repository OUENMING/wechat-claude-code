...
export interface Session {
  ...
  /** Base64-encoded images from the most recent query, used as resume fallback.
   *  Same shape as QueryOptions.images. */
  activeImages?: { type: 'image'; source: { type: 'base64'; media_type: string; data: string } }[];
}
